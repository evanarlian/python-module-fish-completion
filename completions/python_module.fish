...
function __python_module_autocomplete_wrapper -d "Fish wrapper for python module generation"
    set -l tokens (commandline -ct)
    __python_module_autocomplete $tokens
end


complete -c python -s m -f -d 'Local module' -xa '(__python_module_autocomplete_wrapper)'
complete -c python3 -s m -f -d 'Local module' -xa '(__python_module_autocomplete_wrapper)'
